...
def get_good_work():
    ...
    with open("1000円以上案件.txt","w") as f, open("500円〜999円案件.txt", "w") as k:
    ...
    print("=============================================")
    print(t2 - t1)
    subprocess.call("open ~/Python/crawler/1000円以上案件.txt", shell = True)
    subprocess.call("open ~/Python/crawler/500円〜999円案件.txt", shell = True)
